...
//		HAL_I2C_Mem_Read_DMA(&hi2c2, AT24Cxx_Address, ReadAddr, AT24CXX_MEMADD_SIZE, &temp, 1);
//		HAL_I2C_Mem_Read_IT(&hi2c2, AT24Cxx_Address, ReadAddr, AT24CXX_MEMADD_SIZE, &temp, 1);
	}
	else {		
		HAL_I2C_Mem_Read(&hi2c2, (AT24Cxx_Address+((ReadAddr/256)<<1)), (ReadAddr%256), AT24CXX_MEMADD_SIZE, &temp, 1, 100);
//		HAL_I2C_Mem_Read_DMA(&hi2c2, (AT24Cxx_Address+((ReadAddr/256)<<1)), (ReadAddr%256), AT24CXX_MEMADD_SIZE, &temp, 1);
//		HAL_I2C_Mem_Read_IT(&hi2c2, (AT24Cxx_Address+((ReadAddr/256)<<1)), (ReadAddr%256), AT24CXX_MEMADD_SIZE, &temp, 1);
	}
...
//		HAL_I2C_Mem_Write_DMA(&hi2c2, AT24Cxx_Address, WriteAddr, AT24CXX_MEMADD_SIZE, &DataToWrite,  1);
//		HAL_I2C_Mem_Write_IT(&hi2c2, AT24Cxx_Address, WriteAddr, AT24CXX_MEMADD_SIZE, &DataToWrite,  1);
	}
	else {		
		HAL_I2C_Mem_Write(&hi2c2, (AT24Cxx_Address+((WriteAddr/256)<<1)), (WriteAddr%256), AT24CXX_MEMADD_SIZE, &DataToWrite,  1, 100);
//		HAL_I2C_Mem_Write_DMA(&hi2c2, (AT24Cxx_Address+((WriteAddr/256)<<1)), (WriteAddr%256), AT24CXX_MEMADD_SIZE, &DataToWrite,  1);
//		HAL_I2C_Mem_Write_IT(&hi2c2, (AT24Cxx_Address+((WriteAddr/256)<<1)), (WriteAddr%256), AT24CXX_MEMADD_SIZE, &DataToWrite,  1);
	}	
//	HAL_Delay(2);		//AT24C02需要延时，FRAM16不需要延时
}
